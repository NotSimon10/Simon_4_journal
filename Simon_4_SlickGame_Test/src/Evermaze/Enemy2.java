...
import static Evermaze.Evermaze.player;
...
public class Enemy2 {
    ...
    boolean[][] eblocked2 = blocked2.getblocked2();
    ...
    private boolean canigoleft() {
        ...
        return (!isBlocked2(this.Bx - SIZE / 2, this.By + SIZE / 2)
                ...
                || !isBlocked2(this.Bx - fdelta, this.By + SIZE - 16) //|| !isBlocked(this.Bx, this.By + SIZE/2)
