 ...
 */
package simon_4_datatypes;
public class Simon_4_datatypes {
...
//        System.out.println(i + a + " an integer" + "plus a float ")
    	 ...
    	 * concatenates the int and string as
    	 * a string
    	 */
//        a = 2.5f;
//        b = 3.2;
//        System.out.println(a + " a float/ " + "plus a double");
//        
//        b = 3.1;
//        c = 16;   
